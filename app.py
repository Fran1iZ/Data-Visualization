...
layout = go.Layout(
    title='Comparison of ' + 'Portugal'+ ' with the best and worst countries of ' + '2015',
...
@app.callback(Output('fig_Bar','figure'),[Input('CountryDropdown','value'),Input('slider','value')])
def updateCountryandYear(country,year):
    if year == 2015:
        val = df_2015
    elif year == 2016:
        val = df_2016
    ...
    last = val.iloc[-1:, val.columns.get_loc("Country")].values[0]
    penult = val.iloc[-2:-1, val.columns.get_loc("Country")].values[0]
    second = val.iloc[1:2, val.columns.get_loc("Country")].values[0]
    first = val.iloc[:1, val.columns.get_loc("Country")].values[0]

    trace1comp = {
        "name": "Happiness Score",
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['Happiness Score']].values[0][0],
              val.loc[val['Country'] == penult, ['Happiness Score']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['Happiness Score']].values[0][0],
              val.loc[val['Country'] == second, ['Happiness Score']].values[0][0],
              val.loc[val['Country'] == first, ['Happiness Score']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
        "marker": {
        "color": "rgba(253,231,37,1)"}
    ...
    trace2comp = {
        ...
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['GDP per Capita']].values[0][0],
              val.loc[val['Country'] == penult, ['GDP per Capita']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['GDP per Capita']].values[0][0],
              val.loc[val['Country'] == second, ['GDP per Capita']].values[0][0],
              val.loc[val['Country'] == first, ['GDP per Capita']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
            "marker": {
            "color": "rgba(159,218,58,1)"}
    ...
    trace3comp = {
        ...
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['Life Expectancy']].values[0][0],
              val.loc[val['Country'] == penult, ['Life Expectancy']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['Life Expectancy']].values[0][0],
              val.loc[val['Country'] == second, ['Life Expectancy']].values[0][0],
              val.loc[val['Country'] == first, ['Life Expectancy']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
        "marker": {
            "color": "rgba(74,193,109,1)"}
    ...
    trace4comp = {
        ...
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['Freedom']].values[0][0],
              val.loc[val['Country'] == penult, ['Freedom']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['Freedom']].values[0][0],
              val.loc[val['Country'] == second, ['Freedom']].values[0][0],
              val.loc[val['Country'] == first, ['Freedom']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
        "marker": {
            "color": "rgba(39,127,142,1)"}
    ...
    trace5comp = {
        ...
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['Government Corruption']].values[0][0],
              val.loc[val['Country'] == penult, ['Government Corruption']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['Government Corruption']].values[0][0],
              val.loc[val['Country'] == second, ['Government Corruption']].values[0][0],
              val.loc[val['Country'] == first, ['Government Corruption']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
        "marker": {
            "color": "rgba(54,92,141,1)"}
    ...
    trace6comp = {
        ...
        "type": "bar",
        "x": [last, penult, "{}".format(country), second, first],
        "y": [val.loc[val['Country'] == last, ['Generosity']].values[0][0],
              val.loc[val['Country'] == penult, ['Generosity']].values[0][0],
              val.loc[val['Country'] == "{}".format(country), ['Generosity']].values[0][0],
              val.loc[val['Country'] == second, ['Generosity']].values[0][0],
              val.loc[val['Country'] == first, ['Generosity']].values[0][0]],
        "xaxis": "x",
        "yaxis": "y",
        "marker": {
            "color": "rgba(70,51,126,1)"}
    ...
    layout = go.Layout(
        title='Comparison of ' + str(country) + ' with the best and worst countries of ' + str(year),
        xaxis=dict(title='Country'),
        yaxis=dict(title='Score'),
        barmode="group"
    )
